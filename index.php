...
if ($get_page == "" || $get_page == 1) {
    ...
    for ($x = 0; $x < sizeof($result_array); $x++) {
        $post = new post_class($result_array[$x]['post_id'], $result_array[$x]['post_title'], $result_array[$x]['post_content'], $result_array[$x]['post_image'], $result_array[$x]['post_date'], $result_array[$x]['post_tags'], $result_array[$x]['member_id']);
        $array_post[$x] = $post;
    }
                            ...
                            foreach ($result_array2 as $result2):
                                ...
                                <div class='post'>
                                    <div class='post-details'>
                                        <div class='row'>
                                            <div class="col-sm-10">
                                                <h2 class='post-title'><a href="post?id=<?php echo htmlspecialchars($post_id); ?>"><?php echo htmlspecialchars($result->getPost_title()); ?></a></h2>
                                                <div class='post-tags'>
                                                    <?php
                                                    $count = 0;
                                    ...
                                    <?php } ?>
                                    <p class='post-content'><?php echo truncate(htmlspecialchars($result->getPost_content()), 200); ?></p>
