...
if (!empty($_FILES['picture']['name'])) {
	...
	if (isset($message)) {
		...
		$query3 = "INSERT INTO post (post_title, post_content, post_image, post_tags, allow_comments, member_id) VALUES (:post_title, :post_content, :post_image, :post_tags, :allow_comments, :member_id )";
    ...
    $query3 = "INSERT INTO post (post_title, post_content, post_tags, allow_comments, member_id) VALUES (:post_title, :post_content, :post_tags, :allow_comments, :member_id )";
    $statement3 = $db->prepare($query3);
    $statement3->bindValue(":post_title", $post_title);
    $statement3->bindValue(":post_content", $post_content);
    $statement3->bindValue(":post_tags", $replaced_post_tags);
